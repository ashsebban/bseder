...
export function SignUpForm() {
  ...
  return (
    <div className="rounded-3xl border border-line/60 bg-surface p-8 shadow-panel">
      ...
      <p className="mb-6 text-sm text-text-muted">Start keeping everything B&apos;Seder.</p>
        ...
        <div>
          ...
          {strength && (
            <div className="mt-1.5 flex items-center gap-2">
                ...
                {(["weak", "fair", "strong"] as const).map((level, i) => (
                  <div
                    ...
                    className={cn(
                      ...
                      strengthIndex(strength) >= i
                        ? level === "weak" ? "bg-red-400"
                          : level === "fair" ? "bg-amber-400"
                          : "bg-success"
                        : "bg-line",
                    )}
                  />
              ...
              <span className="text-xs text-text-subtle capitalize">{strength}</span>
            </div>
          )}
        </div>
...
function strengthIndex(s: "weak" | "fair" | "strong") {
  return s === "weak" ? 0 : s === "fair" ? 1 : 2;
}
